...
// The SpawnHedgeTile class. This defines a hedge tile that belongs to our spawn level.
public class SpawnHedgeTile extends Tile {
	...
	// Return true, meaning the tile is solid and nothing can pass through it.
	public boolean solid() {
		return true;
	}

	// This tile can be broken, and thus later passed through. This will be implemented
	// WAY later in the series (episode 100+).
